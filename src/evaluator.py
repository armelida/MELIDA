...
Main evaluator script for running tests on AI models with MIR exam questions.
"""
...
class ModelEvaluator:
    ...
    def evaluate_question(self, question: Dict, prompt_strategy: str, model: str) -> Dict:
        ...
        prompt_template = self.prompt_strategies[prompt_strategy]
    ...
    def calculate_score(self, model_answer: str, correct_answer: str) -> int:
        ...
        if model_answer == "INVALID" or model_answer == "ERROR":
